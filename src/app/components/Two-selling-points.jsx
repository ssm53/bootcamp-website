...
"use client";
export default function TwoSellingPoints() {
  return (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <div className="text-center space-y-1">
              ...
              <p className="text-muted-foreground text-base">
                We connect you with businesses to build your first project...for
                a real business!
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center space-y-3">
            ...
            <div className="text-center space-y-1">
              <h3 className="text-xl font-semibold">Bonus 1</h3>
              <p className="text-muted-foreground text-base">
                You will learn Langchain... a tool used to build AI tech
                products
              </p>
            </div>
          </div>
